defmodule RestaurantCheckerWeb.Router do
  ...
  # scope "/api", RestaurantCheckerWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:restaurant_checker, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: RestaurantCheckerWeb.Telemetry
